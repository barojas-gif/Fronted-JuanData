...
@Component({
  selector: 'app-componente-subir-documento',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './componente-subir-documento.component.html',
  styleUrls: ['./componente-subir-documento.component.css']
})
export class ComponenteSubirDocumentoComponent {
