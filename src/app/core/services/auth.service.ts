...
export class AuthService {
  ...
  login(correoUsuario: string, contrasenaUsuario: string): Observable<AuthResponse> {
    return this.http.post<AuthResponse>(`${this.apiUrl}/login`, { correoUsuario, contrasenaUsuario });
  }
