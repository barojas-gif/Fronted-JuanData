...
@Component({
  selector: 'app-componente-semestre',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './componente-semestre.component.html',
  styleUrls: ['./componente-semestre.component.css']
})
export class ComponenteSemestreComponent implements OnInit {
