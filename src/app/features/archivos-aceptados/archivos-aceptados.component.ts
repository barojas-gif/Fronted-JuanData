...
@Component({
  selector: 'app-archivos-aceptados',
  standalone: true,
  imports: [MenuComponent, CommonModule, FormsModule],
  templateUrl: './archivos-aceptados.component.html',
  styleUrl: './archivos-aceptados.component.css'
})
export class ArchivosAceptadosComponent {
  ...
  documentosAceptados: DocumentoPendiente[] = [];
  ...
  cargarDocumentosPendientes() {
    this.documentosService.obtenerDocumentosAceptados().subscribe({
      next: (data) => {
        ...
        this.documentosAceptados = data.sort((a, b) =>
