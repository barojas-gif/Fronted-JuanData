...
@Component({
  selector: 'app-modal-doc-semillero',
  standalone: true,
  imports: [CommonModule, FormsModule],
  providers: [DocumentosService],
  templateUrl: './modal-doc-semillero.component.html',
  styleUrls: ['./modal-doc-semillero.component.css']
})
export class ModalDocSemilleroComponent implements OnInit {
