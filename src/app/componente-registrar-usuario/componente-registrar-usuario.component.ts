...
@Component({
  selector: 'app-componente-registrar-usuario',
  standalone: true,
  imports: [RouterModule, FormsModule, CommonModule, ReactiveFormsModule],
  templateUrl: './componente-registrar-usuario.component.html',
  styleUrl: './componente-registrar-usuario.component.css'
})
export class ComponenteRegistrarUsuarioComponent implements OnInit {
